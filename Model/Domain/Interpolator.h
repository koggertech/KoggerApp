...
public:
    ...
    void setInterpolationLevel(uint8_t level)
    {
        mInterpLevel = level;
    ...
    QuadsPointer interpolate(TrianglesPointer pTriangles)
    {
        ...
        for (size_t row = 0; row < cells_count; row++){
            for (size_t col = 0; col < cells_count; col++)
            {
                Point3D <T> p;
        ...
        for (size_t row = 0; row < cells_count - 1; row++){
            for (size_t col = 0; col < cells_count - 1; col++)
            {
                Point3D <T> A;
                Point3D <T> B;
                Point3D <T> C;
...
private:
    ...
    {
        auto& c = p;
        double w_1 = ((t.A().y() - t.C().y()) * (c.x() - t.C().x()) + (t.C().x() - t.A().x()) * (c.y() - t.C().y())) /
                     ((t.A().y() - t.C().y()) * (t.B().x() - t.C().x()) + (t.C().x() - t.A().x())*(t.B().y() - t.C().y()));

        double w_2 = ((t.C().y() - t.B().y()) * (c.x() - t.C().x()) + (t.B().x() - t.C().x()) * (c.y() - t.C().y())) /
                     ((t.A().y() - t.C().y()) * (t.B().x() - t.C().x()) + (t.C().x() - t.A().x())*(t.B().y() - t.C().y()));

        double w_3 = 1 - w_1 - w_2;

        double z = w_1 * t.B().z() + w_2 * t.C().z() + w_3 * t.A().z();
