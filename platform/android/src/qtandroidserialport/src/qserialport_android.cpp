...
//        qWarning() << "Couldn't find class:" << kJniClassName;
        core.consoleInfo("Couldn't find class in Serial Port API:");
        return;
    }
...
//        qWarning() << "Error registering methods: " << val;
        core.consoleInfo("Error registering methods in Serial Port API:");
    } else {
//        qCDebug(AndroidSerialPortLog) << "Native Functions Registered";
        core.consoleInfo("Native Functions Registered in Serial Port API:");
    }
