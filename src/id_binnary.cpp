...
Resp IDBinUsblSolution::parsePayload(FrameParser &proto) {
    if(proto.ver() == v0) {
        ...
        qInfo("USBL id:%d, d: %f, a: %f,e: %f, y: %f", _usblSolution.id, _usblSolution.distance_m, _usblSolution.azimuth_deg, _usblSolution.elevation_deg, _usblSolution.usbl_yaw);
    } else if(proto.ver() == v1) {
